...
const nicknames = ['lad', 'bloke', 'man', 'guy', 'boy']

var arrayLenght = Object.keys(emoji).length

// Create random value
const random = new Random();
function randomValue (lenght){
   return random.integer(1, lenght);
}

// //Select random Emoji
var test = emoji[randomValue(arrayLenght)].char

//Display output on page
// var output = cities[random.integer(1, cities.lenght)] + nicknames[random.integer(1, nicknames.lenght)]
